...
inline double Element::Drivs(int idim) const {return elementsHashTable->Drivs_[idim][ndx_];}
inline void Element::Drivs(int idim, double value) {elementsHashTable->Drivs_[idim][ndx_] =value;}
